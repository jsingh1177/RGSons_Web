...
public class PartyController {
    ...
    // Update party
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> updateParty(@PathVariable Integer id, @RequestBody Party partyDetails) {
        Map<String, Object> response = new HashMap<>();
        try {
    ...
    // Delete party
    @DeleteMapping("/{id}")
    public ResponseEntity<Map<String, Object>> deleteParty(@PathVariable Integer id) {
        Map<String, Object> response = new HashMap<>();
        try {
