...
public class DebitNoteTransactionDTO {
    private Integer id;
    ...
    private List<DebitNoteLedgerDTO> ledgerDetails;
    ...
    public String getOrgInvDate() { return orgInvDate; }
    public void setOrgInvDate(String orgInvDate) { this.orgInvDate = orgInvDate; }
    public List<DebitNoteItemDTO> getItems() { return items; }
    public void setItems(List<DebitNoteItemDTO> items) { this.items = items; }
    public List<DebitNoteLedgerDTO> getLedgerDetails() { return ledgerDetails; }
    public void setLedgerDetails(List<DebitNoteLedgerDTO> ledgerDetails) { this.ledgerDetails = ledgerDetails; }
    ...
    public static class DebitNoteLedgerDTO {
